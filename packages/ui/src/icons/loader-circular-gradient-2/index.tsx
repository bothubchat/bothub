...
export const LoaderCircularGradient2Icon = icon(({ ...props }) => {
  const theme = useTheme();

  let color1 = theme.colors.base.white;
  let color2 = theme.colors.base.white;
  let stopOpacity = 0;

  if (theme.mode === 'light') {
    color1 = 'rgb(7, 61, 195)';
    color2 = theme.colors.accent.primaryLight;
    stopOpacity = 1;
  }
