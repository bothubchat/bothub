...
export const HappyFileIcon = icon(({ ...props }) => (
  <Icon
    size={70}
    viewBox="0 0 70 70"
    fill="none"
  ...
  >
    <IconConsumer>
      {({ stroke = '#4785FF' } = { stroke: '#4785FF' }) => (
        <>
          <g clipPath="url(#clip0_1453_16545)">
            <path
            ...
            />
            <path
              d="M25.7351 48.3823C28.3613 50.3288 31.5552 51.4706 34.9998 51.4706C38.4444 51.4706 41.6383 50.3288 44.2645 48.3823"
              stroke={stroke}
              strokeWidth="2"
              strokeLinecap="round"
            />
