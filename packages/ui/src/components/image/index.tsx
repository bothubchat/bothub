        ...
        {typeof src === 'object' && (
          ...
          >
            {src.mobile && (
              <ImageSource
                srcSet={
                  typeof src.mobile === 'string' ? src.mobile : src.mobile.src
                }
                width={
                  typeof src.mobile === 'object' ? src.mobile.width : undefined
                }
                height={
                  typeof src.mobile === 'object' ? src.mobile.height : undefined
                }
                media={`(max-width: ${theme.mobile.maxWidth})`}
                onLoad={
                  handleLoad as unknown as React.ReactEventHandler<HTMLSourceElement>
                }
              />
            )}
            {src.tablet && (
              <ImageSource
                srcSet={
                  typeof src.tablet === 'string' ? src.tablet : src.tablet.src
                }
                width={
                  typeof src.tablet === 'object' ? src.tablet.width : undefined
                }
                height={
                  typeof src.tablet === 'object' ? src.tablet.height : undefined
                }
            ...
            {src.desktop && (
              <ImageImg
                $hidden={isHidden}
                src={
                  typeof src.desktop === 'string'
                    ? src.desktop
                    : src.desktop.src
                }
                width={
                  typeof src.desktop === 'object'
                    ? src.desktop.width
                    : undefined
                }
                height={
