    ...
    children: (
      <>
        <DescriptionCard
          ...
          text={
            <DescriptionCardText>
              Вы когда-нибудь мечтали написать интересную книгу или статью, но
              не знали, с чего начать? ChatGPT отлично справляется с генерацией
        ...
        <DescriptionCard
          variant="secondary"
          title={
            <DescriptionCardTitle>Решение сложных задач</DescriptionCardTitle>
          }
          text={
            <DescriptionCardText>
        ...
        <DescriptionCard
          ...
          text={
            <DescriptionCardText>
              ...
              вашим указаниям - к примеру, для создания веб-сайта или
              приложения.
            </DescriptionCardText>
          }
        />
        ...
        <DescriptionCard
          ...
          text={
            <DescriptionCardText>
              ...
              помощника в повседневных задачах, предоставив полезную информацию
