...
export const HeaderUserInfoContext = React.createContext<
HeaderUserInfoContextValue | null>(null);
...
export function useHeaderUserInfo(): HeaderUserInfoContextValue {
  ...
  if (!value) {
    throw new Error('useHeaderUserInfo must be used within a HeaderUserInfoProvider.');
  }
