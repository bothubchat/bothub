...
export const HeaderLangDropdownContext = React.createContext<
HeaderLangDropdownContextValue | null>(null);
...
export function useHeaderLangDropdown(): HeaderLangDropdownContextValue {
  ...
  if (!value) {
    throw new Error('useHeaderLangDropdown must be used within a HeaderLangDropdownProvider.');
  }
