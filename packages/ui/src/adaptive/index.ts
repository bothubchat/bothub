  ...
  return (props) => {
    ...
    return css`
      ...
      css`
        ${!isMiniTablet &&
        css`
          @media (min-width: ${parseInt(mobileMaxWidth) +
            1}px) and (max-width: ${tabletMaxWidth}) {
            ${tablet}
          }
        `}
        ${isMiniTablet &&
        css`
          @media (min-width: ${parseInt(miniTabletMaxWidth) +
            1}px) and (max-width: ${tabletMaxWidth}) {
            ${tablet}
          }
          @media (min-width: ${parseInt(mobileMaxWidth) +
            1}px) and (max-width: ${miniTabletMaxWidth}) {
            ${miniTablet}
          }
        `}
      `}
